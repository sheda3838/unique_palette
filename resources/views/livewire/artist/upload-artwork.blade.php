                                ...
                                <div class="mt-1 flex justify-center px-6 pt-10 pb-10 border-4 border-teal-50 dark:border-gray-700 border-dashed rounded-[30px] hover:border-[#1ABC9C] transition-colors relative group overflow-hidden bg-teal-50/20">
                                    <div class="space-y-4 text-center">
                                        ...
                                        <div class="relative group/image cursor-pointer w-full">
                                            ...
                                            <input id="image-upload" type="file" class="sr-only" wire:model="image">
                                        </div>
                                        @else
                                        <div class="p-8">
                                            ...
                                            <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                                <label for="image-upload" class="relative cursor-pointer font-black text-[#1ABC9C] hover:text-teal-600 transition-colors uppercase tracking-widest">
                                                    <span>Select Artwork</span>
                                                    <input id="image-upload" type="file" class="sr-only" wire:model="image">
                                                </label>
                                            </div>
                                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-2">
                                                High-quality JPG/PNG (Max 10MB)
                                            </p>
                                        </div>
                                        @endif

                                        <div wire:loading wire:target="image" class="absolute inset-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm z-10 flex flex-center items-center justify-center">
