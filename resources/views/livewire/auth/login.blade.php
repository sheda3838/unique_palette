    ...
    <div class="relative z-10 w-full max-w-md animate-entrance">
                ...
                <form wire:submit.prevent="login" class="space-y-7">
                    ...
                    <div class="space-y-2 group">
                        <div class="flex justify-between items-center px-2">
                            ...
                            <a href="{{ route('password.request') }}" wire:navigate class="text-[10px] font-black text-gray-400 hover:text-[#2C3E50] uppercase tracking-widest transition-colors">
                                {{ __('Override?') }}
                            </a>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center px-2">
                        <label for="remember_me" class="relative flex items-center cursor-pointer group">
                            <input wire:model="remember" id="remember_me" type="checkbox" class="peer sr-only">
                    ...
                    <button type="submit" wire:loading.attr="disabled" class="group relative w-full flex justify-center py-5 px-6 border border-transparent rounded-[30px] shadow-2xl shadow-teal-500/20 text-xs font-black text-white bg-[#1ABC9C] hover:bg-[#2C3E50] focus:outline-none transition-all duration-500 uppercase tracking-[0.3em]">
                        <span wire:loading.remove class="relative z-10 transition-transform duration-300 group-hover:scale-110">Unlock Portal</span>
        ...
        <div class="mt-10 text-center">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
                ...
                <a href="{{ route('register') }}" wire:navigate class="ml-2 text-[#1ABC9C] hover:text-[#2C3E50] border-b-2 border-teal-100 hover:border-[#2C3E50] transition-all duration-300 pb-1">
                    Get Started
                </a>
            </p>
        </div>
