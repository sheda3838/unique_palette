                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 py-10">
                    <div class="text-center lg:text-left">
                        ...
                        <div class="mt-10 sm:mt-12 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
                            <!-- Using wire:navigate for smooth, SPA-like transitions (Requirement 1) -->
                            <a href="{{ route('gallery') }}" wire:navigate class="w-full sm:w-auto flex items-center justify-center px-12 py-5 border border-transparent text-lg font-black rounded-full text-white bg-[#1ABC9C] hover:bg-teal-600 transition-all shadow-[0_10px_30px_-10px_rgba(26,188,156,0.5)] uppercase tracking-wider">
                                Browse Gallery
                            </a>
                            <a href="{{ route('register') }}" wire:navigate class="w-full sm:w-auto flex items-center justify-center px-12 py-5 border-2 border-[#1ABC9C] text-lg font-black rounded-full text-[#1ABC9C] bg-white hover:bg-teal-50 transition-all uppercase tracking-wider">
                                Join as Artist
                            </a>
                        </div>
                        @endguest
    ...
    <div class="py-24 bg-gray-50 dark:bg-gray-900 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="{{ route('artist.upload') }}" wire:navigate class="btn-primary-teal inline-flex items-center px-12 py-4 text-sm">Upload New Piece</a>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="group bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-gray-100">
                    ...
                    <div class="p-8">
                        ...
                        <a href="{{ route('gallery') }}" wire:navigate class="w-full block text-center py-4 rounded-xl border-2 border-[#1ABC9C] text-[#1ABC9C] font-black uppercase tracking-widest hover:bg-[#1ABC9C] hover:text-white transition-all">View Detail</a>
                    </div>
                </div>
                @empty
                <div class="col-span-full py-20 text-center">
                    <p class="text-xl font-bold text-gray-400">No favorite artworks yet. Start exploring!</p>
                    <a href="{{ route('gallery') }}" wire:navigate class="btn-primary-teal mt-6 inline-block">Explore Gallery</a>
                </div>
                @endforelse
            </div>
            @endif
            ...
            <div class="space-y-32">
                ...
                <div class="relative flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div class="flex-1 bg-white p-12 border-4 border-[#2C3E50] shadow-[20px_20px_0px_#1ABC9C] z-10 max-w-lg">
                        ...
                        <a href="{{ route('gallery') }}" wire:navigate class="inline-block px-12 py-5 bg-[#1ABC9C] text-white font-black rounded-xl uppercase tracking-wider hover:bg-teal-600 transition-all text-base shadow-lg">
                            Start Exploring
                        </a>
                    </div>
                ...
                <div class="relative flex flex-col md:flex-row-reverse items-center gap-16">
                    ...
                    <div class="flex-1 bg-white p-12 border-4 border-[#2C3E50] shadow-[-20px_20px_0px_#1ABC9C] z-10 max-w-lg">
                        ...
                        <a href="{{ route('register') }}" wire:navigate class="inline-block px-12 py-5 bg-[#1ABC9C] text-white font-black rounded-xl uppercase tracking-wider hover:bg-teal-600 transition-all text-base shadow-lg">
                            Start Selling
                        </a>
                    </div>
                    <div class="flex-1 relative">
