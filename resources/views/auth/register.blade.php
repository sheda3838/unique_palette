        ...
        <div class="relative z-10 w-full max-w-md animate-entrance">
                ...
                <div class="p-10 sm:p-12">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-8">
                        ...
                        <div class="flex items-center px-2">
                            <label for="terms" class="relative flex items-center cursor-pointer group">
                                ...
                                <span class="ml-4 text-[10px] font-black text-gray-400 uppercase tracking-widest group-hover:text-gray-600 transition-colors">
                                    ...
                                    'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="text-[#1ABC9C] hover:text-[#2C3E50] border-b border-teal-100 transition-all">'.__('Terms of Service').'</a>',
                                    'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="text-[#1ABC9C] hover:text-[#2C3E50] border-b border-teal-100 transition-all">'.__('Privacy Policy').'</a>',
                                    ]) !!}
                                </span>
                            </label>
                        </div>
                        ...
                        <button type="submit" class="group relative w-full flex justify-center py-5 px-6 border border-transparent rounded-[30px] shadow-2xl shadow-teal-500/20 text-xs font-black text-white bg-[#1ABC9C] hover:bg-[#2C3E50] focus:outline-none transition-all duration-500 uppercase tracking-[0.3em]">
                            <span class="relative z-10 transition-transform duration-300 group-hover:scale-110">Initialize Credentials</span>
            ...
            <div class="mt-10 text-center">
                <p class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
                    Returning Artisan?
                    <a href="{{ route('login') }}" class="ml-2 text-[#1ABC9C] hover:text-[#2C3E50] border-b-2 border-teal-100 hover:border-[#2C3E50] transition-all duration-300 pb-1">
                        Go to Vault
                    </a>
                </p>
            </div>
